...
urlpatterns = [
    ...
    path('item-checks/', views.item_checks, name='item-checks'),
    path('results-summary/', views.results_summary, name='results-summary'),
    path('result-withholdings/', views.withhold_results, name='withhold-results'),
    path('result-withholdings/<int:pk>/release/', views.release_results, name='release-results'),
    path('finance/payment-schedules/', views.payment_schedules, name='payment-schedules'),
    path('finance/payment-schedules/copy/', views.copy_payment_schedules, name='payment-schedules-copy'),
    path('my-hostel/', views.student_hostel, name='student-hostel'),
    path('postponements/', views.postponements, name='postponements'),
    path('postponements/<int:pk>/decide/', views.decide_postponement, name='postponement-decide'),
    path('my-postponement/', views.student_postponement, name='student-postponement'),
    path('finishing/', views.finishing, name='finishing'),
    path('finishing/<int:profile_id>/<str:step>/', views.finishing_action, name='finishing-action'),
    path('hostel-applications/', views.hostel_applications, name='hostel-applications'),
    path('hostel-applications/<int:pk>/decide/', views.decide_hostel_application, name='hostel-application-decide'),
    path('student-records/<int:profile_id>/', views.student_record, name='student-record'),
